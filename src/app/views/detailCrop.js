                        ...
                        lot.tasks.map(task =>{
                            ...
                            return(
                                <div className="cropTaskDetail" style={Image}>
                                    <h4>{task.name}</h4>
                                    <div className="check">
                                        <h6>Dentro de: {(moment(lot.createdDate).add(task.days+1,'m')).diff(moment().format(),'minutes') > 0 ? (moment(lot.createdDate).add(task.days+1,'m')).diff(moment().format(),'minutes') : 0} dias</h6>
